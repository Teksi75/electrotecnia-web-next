    ...
    <main className="mx-auto w-full max-w-5xl space-y-10 px-4 py-12 sm:px-6 lg:px-8">
      <section className="space-y-6">
        <p className="text-sm text-muted-foreground sm:text-base">
          ...
          <span className="ml-2 inline-block font-semibold tracking-[0.28em] text-amber-700/90">INGENIUM</span>
        </p>
        ...
        <div className="max-w-3xl rounded-xl border border-border bg-secondary p-4 text-sm text-secondary-foreground">
