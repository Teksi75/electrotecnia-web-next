        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            ...
            <h1 className="text-balance text-4xl font-extrabold leading-tight sm:text-5xl">
              Servicio de Electrotecnia para alumnos de INGENIUM: teoría, fórmulas y práctica aplicada
            </h1>
            <p className="max-w-3xl text-lg text-muted-foreground">
              Este espacio de estudio está diseñado para que los alumnos de INGENIUM puedan entender, repasar y
              practicar Electricidad de forma ordenada. Podés recorrerlo en secuencia como curso breve o usarlo como
              material de consulta por tema.
            </p>
